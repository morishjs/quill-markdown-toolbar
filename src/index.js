...
export default class MarkdownToolbar extends Module {
  constructor(quill, options) {
    ...
    const icon = '<svg xmlns="http://www.w3.org/2000/svg" width="27" height="128" viewBox="0 0 208 128"><rect width="198" height="118" x="5" y="5" ry="10" stroke="#000" stroke-width="10" fill="none"/><path d="M30 98V30h20l20 25 20-25h20v68H90V59L70 84 50 59v39zm125 0l-30-33h20V30h20v35h20z"/></svg>';
    document.querySelectorAll('.ql-markdown').forEach(el => el.innerHTML = icon);
  }
